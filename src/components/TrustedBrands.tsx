    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <p className="text-gray-500 text-lg font-medium">Trusted by innovative companies worldwide</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center justify-items-center">
          {brands.map((brand, index) => (
            <div 
              key={brand.name}
              className="flex items-center justify-center w-24 h-24 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors cursor-pointer group"
